...
class FindTest(unittest.TestCase):
    ...
    def test_find_no_results(self, mock_execute):
        ...
        mock_execute.assert_called_with(["restic", "--json", "find", "dummyfile"])
...
""".strip()
            ...
            [
                {
                    ...
                    "hits": 1,
                    "snapshot": "f589421bafdae95f5be5eea6285074b7ddc54aa0ffd1ad606f74d1e6207d20a3",  # pylint: disable-next=line-too-long
                }
            ],
    ...
    @mock.patch.object(snapshots.command_executor, "execute")
    def test_find_matches_multiple_results_in_single_snapshot(self, mock_execute):
        mock_execute.return_value = """
...
""".strip()
    ...
    @mock.patch.object(snapshots.command_executor, "execute")
    def test_find_matches_multiple_results_in_multiple_snapshots(self, mock_execute):
        # pylint: disable-next=line-too-long
        mock_execute.return_value = """
        ...
        self.assertEqual(
            [
                ...
                },
                {
                    ...
                    "hits": 1,
                    "snapshot": "g589421bafdae95f5be5eea6285074b7ddc54aa0ffd1ad606f74d1e6207d20a3",  # pylint: disable-next=line-too-long
                },
            ],
            restic.find("dummyfile"),
        )
