...
class SelfUpdateTest(unittest.TestCase):
    ...
    def test_stats(self, mock_execute):
        ...
        self.assertEqual({"total_size": 20, "total_file_count": 3}, restic.stats())
    ...
    def test_stats_with_mode(self, mock_execute):
        ...
        self.assertEqual(
            {"total_size": 20, "total_file_count": 1, "total_blob_count": 1},
    ...
    def test_stats_with_tag(self, mock_execute):
        ...
        self.assertEqual(
            {"total_size": 10, "total_file_count": 2}, restic.stats(tags=["musician1"])
        )
    ...
    def test_stats_with_host(self, mock_execute):
        ...
        self.assertEqual(
            {"total_size": 10, "total_file_count": 2}, restic.stats(host="myhost")
        )
