...
class BackupTest(unittest.TestCase):
    ...
    def test_excludes_single_pattern(self, mock_execute):
        ...
        mock_execute.assert_called_with(
            ["restic", "--json", "backup", "/data/music", "--exclude", "Justin Bieber*"]
        )
    ...
    def test_excludes_multiple_patterns(self, mock_execute):
        ...
        restic.backup(
            paths=["/data/music"], exclude_patterns=["Justin Bieber*", "Selena Gomez*"]
        )
    ...
    def test_includes_multiple_files_from_file(self, mock_execute):
        ...
        restic.backup(
            paths=["/data/music"], files_from=["good-songs.txt", "best-songs-ever.txt"]
        )
